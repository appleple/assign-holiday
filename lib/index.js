...
var AssignHoliday = /*#__PURE__*/function () {
  ...
  _createClass(AssignHoliday, [{
    key: "run",
    value: function run(holidayData) {
      var _this = this;
      ...
      [].map.call(this.elements, function (element) {
        ...
        [].map.call(targets, function (target) {
          ...
          var isHoliday = _this.isHoliday(date, data);
    ...
    key: "isHoliday",
    value: function isHoliday(date, data) {
    ...
    value: function addHolidayTitle(titleElem, title) {
      ...
      var html = tag ? "<".concat(tag, ">").concat(title, "</").concat(tag, ">") : title;
