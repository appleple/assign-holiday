        ...
        [].map.call(targets, function (target) {
          ...
          if (isHoliday[0]) {
            var _this$option = _this.option,
                ...
                addHolidayLabel = _this$option.addHolidayLabel,
    ...
    value: function addHolidayLabel(labelElem, regex) {
      ...
      switch (holidayLabelPosition) {
        ...
        case 'after':
          ...
          if (i === -1) return;
          labelElem.textContent = (0, _util.insertAdjacentString)(labelElem.textContent, holidayLabelPosition, i, holidayLabel);
          break;
